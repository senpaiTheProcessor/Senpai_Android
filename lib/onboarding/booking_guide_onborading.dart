...
import 'package:senpai/Call/Call.dart';
...
class GuideTutorial extends StatefulWidget {
  final dynamic selectedTab;
  final dynamic tabBarIndex;
  GuideTutorial({Key? key, this.selectedTab, this.tabBarIndex})
      : super(key: key);

  @override
  _GuideTutorialState createState() => _GuideTutorialState();
}

class _GuideTutorialState extends State<GuideTutorial> {
    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
          ...
          InkWell(
                      onTap: (() {
              Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=>CallScreenTutorial()));
            }),
            child: hightlight())
        ],
      ),
      ...
      child: Row(
        ...
        children: [
          ...
          Container(
            ...
            child: Padding(
              padding: const EdgeInsets.symmetric(horizontal: 12, vertical: 5),
              child: Text("Guide Now", style: TextStyle(color: Colors.white)),
            ),
          )
        ],
      ),
  ...
  Widget hightlight() {
    return Stack(
      children: [
        ...
        Positioned(top: 90, right: 10, child: Call()),

        Positioned(right: 150, top: 0, child: search1())
      ],
    );
  }
